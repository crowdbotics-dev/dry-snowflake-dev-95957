"""
Django settings for dry_snowflake_dev_95957 project.
...
ROOT_URLCONF = 'dry_snowflake_dev_95957.urls'
...
WSGI_APPLICATION = 'dry_snowflake_dev_95957.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_snowflake_dev_95957 API",
    "DESCRIPTION": "API documentation for dry_snowflake_dev_95957 App",
    "VERSION": "v1",
}
